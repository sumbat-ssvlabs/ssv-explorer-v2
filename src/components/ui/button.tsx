  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        outline:
          "border hover:bg-accent hover:text-accent-foreground dark:border-white/10",
        secondary:
    ...
    compoundVariants: [
      {
        variant: "link",
        class: "inline h-auto p-0",
      },
      {
        variant: "outline",
        colorScheme: "error",
        class:
          "hover:bg-error-300 border-error-500 bg-error-100 text-error-500 hover:text-error-200 active:bg-error-500",
      },
    ],
    defaultVariants: {
      variant: "default",
...
>(
  (
    ...
    return (
      ...
      >
        <>
          {isLoading ? <CgSpinner className="size-6 animate-spin" /> : icon}
